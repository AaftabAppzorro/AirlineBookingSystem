...
{
    public class GetBookingHandler : IRequestHandler<GetBookingQueryById, Booking>
    {
        ...
        public async Task<Booking> Handle(GetBookingQueryById request, CancellationToken cancellationToken)
        {
